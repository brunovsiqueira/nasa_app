...
import 'package:nasa_app/src/pages/login_page.dart';
import 'package:nasa_app/src/pages/rover_details_page.dart';
import 'package:nasa_app/src/pages/rovers_home_page.dart';
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
            seedColor: const Color.fromARGB(255, 11, 61, 145)),
        useMaterial3: true,
      ),
